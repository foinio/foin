...
const QString BITCOIN_IPC_PREFIX("foin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/foin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/foin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/foin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click foin: links
...
//
// OSX-specific way of handling foin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in foin: URIs
