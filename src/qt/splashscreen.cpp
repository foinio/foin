    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString versionText     = QString("Version 3.0.1");

    QString copyrightTextBitcoin     = QChar(0xA9)+QString(" %1-%2 ").arg(2009).arg(COPYRIGHT_YEAR) + QString("The Bitcoin Core developers");
    QString copyrightTextBlackmore   = QChar(0xA9)+QString(" 2018-%2 ").arg(2019).arg(COPYRIGHT_YEAR) + QString("The Foin developers");
