...
QVariant TransactionTableModel::txAddressDecoration(const TransactionRecord *wtx) const
{
    ...
    {
    case TransactionRecord::Generated:
        return QIcon(fUseBitsTheme ? ":/icons/bits/tx_mined" : ":/icons/tx_mined");
    case TransactionRecord::RecvWithAddress:
    case TransactionRecord::RecvFromOther:
        return QIcon(fUseBitsTheme ? ":/icons/bits/tx_input" : ":/icons/tx_input");
    case TransactionRecord::SendToAddress:
    case TransactionRecord::SendToOther:
        return QIcon(fUseBitsTheme ? ":/icons/bits/tx_output" : ":/icons/tx_output");
    default:
        return QIcon(fUseBitsTheme ? ":/icons/bits/tx_inout" : ":/icons/tx_inout");
    }
    return QVariant();
}
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        {
            return fUseBitsTheme ? QColor(0, 255, 0) : QColor(0, 128, 0);
        }
