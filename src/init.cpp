...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/foinio/foin>";
    const std::string URL_WEBSITE = "<https://github.com/foinio/foin/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i-%i The Foin  Developers", 2018, COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Foin useful. "
